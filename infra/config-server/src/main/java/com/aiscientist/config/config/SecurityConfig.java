package com.aiscientist.config.config;
 ...
 * 1. Config Server clients communicate via REST APIs, not browser-based forms
 * 2. HTTP Basic auth doesn't use cookies/sessions, making CSRF attacks inapplicable
 * 3. All Config endpoints require authentication via Authorization header
 */
@Configuration
@EnableWebSecurity
